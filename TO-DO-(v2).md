...
>
> **Avancement (2026-06-12)** : ✅ T0.1, T0.2, T1.2, T2.1, T2.2, T5.2, T5.4 faits. T5.3 : README déjà exact, reste le `uiConfirm()` avant le fallback Jina. **Restant : T1.1, Phase 3, Phase 4, T5.1, T5.3 (partiel), Phase 6.**
